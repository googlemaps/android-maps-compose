 ...
 *
 * This snippet uses [Polyline] inside the [GoogleMap] content block, customizing the line's color
 * to blue and thickness to 10 pixels.
 */
@Composable
fun PolylineSnippet() {
  ...
  val points = remember { listOf(LatLng(1.35, 103.87), LatLng(1.40, 103.77), LatLng(1.45, 103.77)) }
 ...
 *
 * This snippet configures a [Polygon] with a translucent red fill color and a solid red border
 * stroke.
 */
@Composable
fun PolygonSnippet() {
  ...
  val points = remember { listOf(LatLng(1.35, 103.87), LatLng(1.40, 103.77), LatLng(1.40, 103.90)) }
 ...
 *
 * This Composable uses [Circle] with a radius specified in meters (2,000m) and styles it with a
 * translucent green fill and a solid green outline.
 */
@Composable
fun CircleSnippet() {

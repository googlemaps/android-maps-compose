...
package gradle.kotlin.dsl.accessors._33adc91b7b41cfbcc23eb120773ac865
 ...
 * @see [DependencyHandler.add]
 */
@Deprecated("Use single-string notation or DependencyFactory instead. The dokkaJekyllRuntime configuration has been deprecated for dependency declaration. Please use the 'dokkaJekyllGeneratorRuntime' configuration instead.")
internal
fun DependencyHandler.`dokkaJekyllRuntime`(
    group: String,
    name: String,

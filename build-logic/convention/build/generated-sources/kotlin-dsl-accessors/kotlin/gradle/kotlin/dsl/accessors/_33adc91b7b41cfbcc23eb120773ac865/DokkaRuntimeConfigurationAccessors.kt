 ...
 * @see [DependencyHandler.add]
 */
@Deprecated("Use single-string notation or DependencyFactory instead. The dokkaRuntime configuration has been deprecated for dependency declaration. Please use the 'dokkaGeneratorRuntime' configuration instead.")
internal
fun DependencyHandler.`dokkaRuntime`(
    group: String,
    name: String,

 ...
 * @see [DependencyHandler.add]
 */
@Deprecated("Use single-string notation or DependencyFactory instead. The dokkaGfmPlugin configuration has been deprecated for dependency declaration. Please use the 'dokkaGfmPlugin' configuration instead.")
internal
fun DependencyHandler.`dokkaGfmPlugin`(
    group: String,
    name: String,

 ...
 * @see [DependencyHandler.add]
 */
@Deprecated("Use single-string notation or DependencyFactory instead. The dokkaGfmRuntime configuration has been deprecated for dependency declaration. Please use the 'dokkaGfmGeneratorRuntime' configuration instead.")
internal
fun DependencyHandler.`dokkaGfmRuntime`(
    group: String,
    name: String,

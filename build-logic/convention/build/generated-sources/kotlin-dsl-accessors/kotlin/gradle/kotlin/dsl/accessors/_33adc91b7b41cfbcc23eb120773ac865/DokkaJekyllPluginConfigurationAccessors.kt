 ...
 * @see [DependencyHandler.add]
 */
@Deprecated("Use single-string notation or DependencyFactory instead. The dokkaJekyllPlugin configuration has been deprecated for dependency declaration. Please use the 'dokkaJekyllPlugin' configuration instead.")
internal
fun DependencyHandler.`dokkaJekyllPlugin`(
    group: String,
    name: String,

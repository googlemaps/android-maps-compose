...
package gradle.kotlin.dsl.plugins._59086d385571251b6a3c6eb5dc52d985
...
/**
 * The `com.android.internal.r8` plugin implemented by [com.android.build.gradle.internal.plugins.R8Plugin].
 */
internal
val `ComAndroidInternalPluginGroup`.`r8`: PluginDependencySpec
    get() = plugins.id("com.android.internal.r8")
...
/**
 * The `com.android.r8` plugin implemented by [com.android.build.gradle.R8Plugin].
 */
internal
val `ComAndroidPluginGroup`.`r8`: PluginDependencySpec
    get() = plugins.id("com.android.r8")

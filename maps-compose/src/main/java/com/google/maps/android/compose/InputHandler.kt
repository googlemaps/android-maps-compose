...
/**
 * A generic handler for map input. Non-null lambdas will be invoked if no other node was able to
 * handle that input. For example, if [OnMarkerClickListener.onMarkerClick] was invoked and no
 * matching [MarkerNode] was found, this [onMarkerClick] will be invoked.
 */

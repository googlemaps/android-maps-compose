...
public class WmsUrlTileProvider(
  ...
  private val urlFormatter:
    (xMin: Double, yMin: Double, xMax: Double, yMax: Double, zoom: Int) -> String
  ...
  private companion object {
    /**
     * The maximum extent of the Web Mercator projection (EPSG:3857) in meters. This is the distance
     * from the origin (0,0) to the edge of the world map. Calculated as semi-major axis of Earth
     * (6378137.0) * PI.
     */
  ...
  internal fun getBoundingBox(x: Int, y: Int, zoom: Int): DoubleArray {
    ...
    // WMS Bounding Box expects yMin to be the southern-most latitude and yMax to be the
    // northern-most.

...
/**
 * This activity demonstrates how to use [WmsTileOverlay] to display a Web Map Service (WMS) layer
 * on a map.
 */
    ...
    setContent {
      ...
      Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
          ...
          Button(
            onClick = { mapType = if (mapType == MapType.NONE) MapType.NORMAL else MapType.NONE }
          ) {
